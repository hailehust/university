 ...
 * @author hai
 */
public class YearlyStudentSession extends javax.swing.JFrame {
     ...
     */
    public YearlyStudentSession(University university, String mssv) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YearlyStudentSession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        jComboBoxMaHocKyHeThong2.addItem("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new ChangePasswordView(university, mssv).setVisible(true);
